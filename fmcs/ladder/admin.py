...
from .models import Players, PlayerStatsNode, PlayerRatingNode, RatingPeriod, Matches, MatchupStatsNode
...
class PlayerAdmin(ImportExportModelAdmin):
    list_display = ('name', 'discord_id', 'user', 'country', 'ranking', 'rating', 'is_active')
...
class MatchAdmin(ImportExportModelAdmin):
    ...
    list_display = (
        'id', 'game_num', 'player1', 'player2', 'num_matches', 'player1_goals_m1', 'player2_goals_m1',
        'player1_goals_m2',
        'player2_goals_m2',
